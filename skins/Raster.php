 ...
 * @ingroup Skins
 */
class SkinRaster extends SkinTemplate {
	/** Using raster. */
	var $skinname = 'raster', $stylename = 'raster',
		$template = 'RasterTemplate', $useHeadElement = true;
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addModuleStyles( 'skins.raster' );
		...
		$out->addStyle( 'raster/IE60Fixes.css', 'screen', 'IE 6' );
		$out->addStyle( 'raster/IE70Fixes.css', 'screen', 'IE 7' );
 ...
 * @ingroup Skins
 */
class RasterTemplate extends BaseTemplate {

	/**
	 * Template filter callback for Raster skin.
